        ...
        <div className="footer_container">
                ...
                <div >
                    <nav className="footer_navigation">
                        <ul>
                            <li className="footer_navigation--portfolio">
                                <a className="footer_navigation--portfolio_link" href="portfolio">Portfolio<br />
                            ...
                            <li className="footer_navigation--blog">
                                <a className="footer_navigation--blog_link" href="blog">Blog<br />
                            ...
                            <li className="footer_navigation--contact">
                                <a className="footer_navigation--contact_link" href="/contact">Contact<br />
                            ...
                            <li className="footer_navigation--design">
                                <a className="footer_navigation--design_link" href="/design">Design<br />
